...
When computing the product of these two DFA's, the resulting transition table is shown in Table \ref{table-exp1-dfaprod} and diagram shown in Fig. \ref{fig-exp1-dfaprod}.
...
When computing the product of these two DFA's, the resulting transition table is shown in Table \ref{table-exp2-dfaprod} and diagram shown in Fig. \ref{fig-exp2-dfaprod}.
